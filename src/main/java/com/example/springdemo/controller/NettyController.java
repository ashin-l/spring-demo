...
public class NettyController {
    ...
    public Result sendMsg(String uuid, String msg) {
        ...
        msg = Integer.toHexString(startCode) + Integer.toHexString(len) + Integer.toHexString(netSn)
                + Integer.toHexString(sn) + Integer.toHexString(opcode) + Integer.toHexString(checkCode);
        // System.out.println(msg);
        var tmp = HexStringUtil.getHexBytes(msg);
        // System.out.println(tmp);
        // System.out.println(tmp.toString());
        // NettyServerHandler.sendMessage(uuid, msg);
        NettyServerHandler.sendMessage(tmp);
        return Result.ok();
    }
}
